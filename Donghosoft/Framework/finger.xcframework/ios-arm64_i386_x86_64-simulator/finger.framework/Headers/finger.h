...
#import <finger/fingerUserInfo.h>


typedef enum {
    kInAppOnClick,  //인앱 - 메세지 클릭
    kInAppNotToday, //인앱 - 오늘은 안보기
    kInAppClose,    //인앱 - 닫기
    kInAppFail,     //인앱 - 에러 발생 error 참고
...
#pragma mark - 
//노티피케이션 뱃지 싱크
#if !TARGET_OS_WATCH && __IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_10
...
#pragma mark - 
- (void)requestSendUserInfo:(void (^)(NSDictionary *posts, NSError *error))block;

@property(strong, nonatomic) fingerUserInfo* user;
